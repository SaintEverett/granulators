...
2 => int GRAINS_PER_CHAN; // nchan sets an amount of grain "objects" positioned in ambisonic space, controlled by the numpad, how many granulators would you like per object?
