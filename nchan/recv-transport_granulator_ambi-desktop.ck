...
OscIn oin[4];
oin[0].addAddress("/keypresses/down");
oin[1].addAddress("/keypresses/up");
oin[2].addAddress("/trackpad/x");
oin[3].addAddress("/trackpad/y");
...
fun void miceWatch()
{
    ...
    while(true)
    {
        ...
        {
            mosmsg.getFloat(0) => position[0];
            mosmsg.getFloat(1) => position[1];
...
while(true)
{
    ...
    while(key.recv(msg))
    {
        if(msg.address == "keypresses/down")
        {
